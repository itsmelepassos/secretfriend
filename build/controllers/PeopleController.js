...
exports.searchPerson = exports.destroy = exports.update = exports.store = exports.getPerson = exports.getAll = void 0;
...
const store = async (req, res) => {
    ...
    const newPerson = await people.store({
        name: body.data.name,
        cpf: body.data.cpf,
        id_event: parseInt(id_event),
        id_group: parseInt(id_group),
...
const destroy = async (req, res) => {
    const { id, id_event, id_group } = req.params;
    const deletedPerson = await people.destroy({
        id: parseInt(id),
        id_event: parseInt(id_event),
        id_group: parseInt(id_group),
    });
